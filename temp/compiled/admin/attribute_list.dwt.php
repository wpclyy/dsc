        ...
        <div class="content">		
            ...
            <div class="flexilist">
                ...
                <div class="common-head">
                    <div class="fl">
                    	<a href="attribute.php?act=add&goods_type=<?php echo $this->_var['goods_type']; ?>"><div class="fbutton"><div class="add" title="添加属性"><span><i class="icon icon-plus"></i>添加属性</span></div></div></a>
                    </div>				
                    <div class="refresh">
                            	...
                            	<tr>
                                    ...
                                    <td class="handle">
                                        <div class="tDiv a2 tl">
                                            ...
                                            <?php endif; ?>
                                            <a href="attribute.php?act=edit&amp;attr_id=<?php echo $this->_var['attr']['attr_id']; ?>" class="btn_edit"><i class="icon icon-edit"></i>编辑</a>
                                            <a href="javascript:;" onclick="removeRow(<?php echo $this->_var['attr']['attr_id']; ?>)" class="btn_trash"><i class="icon icon-trash"></i>删除</a>										
                                        </div>
                                    </td>
									<?php endif; ?>
                                </tr>
