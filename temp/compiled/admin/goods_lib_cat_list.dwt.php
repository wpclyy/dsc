            ...
            <div class="flexilist">
                ...
                <div class="common-head">
					...
					<?php if ($this->_var['parent_id'] > 0): ?>
                    	<a href="goods_lib_cat.php?act=list&parent_id=<?php echo $this->_var['parent_id']; ?>&back_level=<?php echo $this->_var['level']; ?>"><div class="fbutton"><div class="add" title="返回上一级"><span><i class="icon icon-reply"></i>返回上一级</span></div></div></a>
					<?php endif; ?>
					<a href="goods_lib_cat.php?act=add<?php if ($this->_var['parent_id']): ?>&parent_id=<?php echo $this->_var['parent_id']; ?><?php endif; ?>"><div class="fbutton"><div class="add" title="添加分类"><span><i class="icon icon-plus"></i>添加分类</span></div></div></a>
                    </div>
                </div>
...
?>
                            	<tr>
                                	<td>
                                    	<div class="tDiv first_setup">
                                        	<div class="setup_span">
                                                ...
                                                <ul>
                                                	<li><a href="goods_lib_cat.php?act=add&parent_id=<?php echo $this->_var['cat']['cat_id']; ?>">新增下一级</a></li>
                                                    <li><a href="goods_lib_cat.php?act=list&parent_id=<?php echo $this->_var['cat']['cat_id']; ?>&level=<?php echo $this->_var['level']; ?>">查看下一级</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="handle">
                                        <div class="tDiv a2">
                                            <a href="goods_lib_cat.php?act=edit&amp;cat_id=<?php echo $this->_var['cat']['cat_id']; ?>" class="btn_edit"><i class="icon icon-edit"></i>编辑</a>
